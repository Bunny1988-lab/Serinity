        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 bottom-0 w-72 bg-surface/95 backdrop-blur-xl border-r border-outline-variant/30 z-[110] flex flex-col py-8 px-6 md:hidden shadow-2xl overflow-y-auto hide-scrollbar"
            >
              {/* Header row */}
