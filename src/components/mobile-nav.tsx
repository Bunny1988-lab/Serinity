...
export function MobileNav({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-background/95 border-t border-border/40 backdrop-blur-2xl shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-50 pb-safe">
      <div className="flex justify-between items-center px-6 py-3">
        <MobileNavItem href="/home"        active={pathname === '/home'}              icon={<Home      size={24} strokeWidth={pathname === '/home' ? 2 : 1.5} />} label="Home" />
